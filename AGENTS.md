# Geography for Secondary Schools: Student’s Book Form One — ADT Bundle Reference
...
**Geography for Secondary Schools: Student’s Book Form One** — This is an English-language geography textbook from Tanzania, produced by the Tanzania Institute of Education for Form One secondary students, roughly equivalent to lower secondary or early teenage level. It introduces foundational physical and human geography, covering the Earth and solar system, rotation and revolution, latitude and longitude, continents, relief features, water bodies, ocean floors and vegetation. The book follows a competency-based, activity-led approach with exercises, projects and practical tasks, and it strongly emphasises environmental awareness, map and observation skills, and the relationship between geography and everyday life in the Tanzanian and wider global context.
...
```
GEOGRAPHY--F1---CONFERENCE-DUMMY-4.08.25/
├── adt/                              # THE WEB APP
...
├── GEOGRAPHY--F1---CONFERENCE-DUMMY-4.08.25.db                    # SQLite database (pipeline state)
├── GEOGRAPHY--F1---CONFERENCE-DUMMY-4.08.25.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg000_im001": "Geography for Secondary Schools. Student’s Book, Form One. Tanzania Institute of Education. An olive-green cover with blue lettering, a photograph of a spiral galaxy and the Tanzania Institute of Education emblem. Property of the Government of the United Republic of Tanzania, Not for Sale.",
  "gl001": "abyssal hill",
  "gl001_def": "A small, steep hill rising from the deep ocean floor."
}
```
...
```json
{
  "abyssal hill": {
    "word": "abyssal hill",
    "definition": "A small, steep hill rising from the deep ocean floor.",
    "variations": ["abyssal hill","abyssal hills"],
    "emoji": "🌊⛰️"
  }
}
```
...
```json
{
  "title": "Geography for Secondary Schools: Student’s Book Form One",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
| Original PDF | `GEOGRAPHY--F1---CONFERENCE-DUMMY-4.08.25.pdf` |
| Pipeline database | `GEOGRAPHY--F1---CONFERENCE-DUMMY-4.08.25.db` (SQLite) |
